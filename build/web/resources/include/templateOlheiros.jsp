        ...
        <div id="sidebar-wrapper">
            <ul class="sidebar-nav">
                ...
                <li>Inserir dados em tempo real
                    <ul>
                        <li><a href="getList">Inserir Tendências de ataque</a></li>
                        <li><a href="getList">Inserir Tendências de Passe</a></li>
                        <li><a href="getList">Inserir Tendências de Serviço</a></li>
                        <li><a href="getList">Inserir Falhas de Receção</a></li>
                    </ul>
                </li>
