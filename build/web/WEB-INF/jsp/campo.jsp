                        ...
                        <div id="rotacaoCampo2" >
                            <h3> Rotação Campo 2 <label id="r2">1<label> </h3>
                                        ...
                                        <span id="casa">
                                            <span id="pontoCasa">
                                                <label>Casa</label>
                                                <input type="button" class="button" id="btncasa" onclick="pontoCum('casa')" value="0" />
                                            </span>
                                            <span id ="setCasa">
                                                <label>Set</label>
                                        ...
                                        <span id="fora">
                                            <span id="pontoFora">
                                                <label>Fora</label>
                                                <input type="button" class="button" id="btnfora" onclick="pontoCum('fora')" value="0"/>
                                            </span>
                                            <span id ="setFora">
                                                <label>Set</label>
                                        ...
                                        <div id="popUpDivAtaques" name="ataques">
                                         ...
                                         <div id="popUpDivBlocos" name="ataques">
                                            <h2> Bloco</h2>
                                            <input type="radio" name="class" id="radio-mini-1" value=0  />
                                            <label for="class">Erro</label>
                                            <br>
                                        ...
                                        <script>
                                            ...
                                            function controlo() {
                                                ...
                                                if (nJogadas == 2) {
                                                    if (($.inArray(posicaoUjogada, campo2) >= 0) && (posicaoPjogada == 19)) {
                                                        $('#jogadasTxt').html('servico para a zona' + posicaoUjogada);
                                                        $("#popUpDivServicos").show();

                                                        } else if (($.inArray(posicaoUjogada, campo1) >= 0) && (posicaoPjogada == 20)) {
                                                            $('#jogadasTxt').html('servico para a zona' + posicaoUjogada);
                                                            $("#popUpDivDefesas").show();

                                                      
                                                    } else if (($.inArray(posicaoUjogada, campo1) >= 0) || ($.inArray(posicaoUjogada, fora) >= 0) && (posicaoPjogada == 19)) {
                                                        $('#jogadasTxt').html('erro, ponto equipa adversaria');
                                                        classificacao = 0;
                                                        tipoEstatistica = 1;
                                                        ...
                                                        $('#jogadasTxt').html('erro, ponto para a nossa equipa');
                                                        classificacao = 0;
                                                        tipoEstatistica = 2;
                                                        rotacaoP = ar[nJogadas - 2] [0];
                                                        rotacaoEA = ar[nJogadas - 1] [0];
