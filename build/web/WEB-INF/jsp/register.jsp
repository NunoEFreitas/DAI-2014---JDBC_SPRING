    ...
    <body onload="oculta(1);" >
        ...
        <form:form  id="contactform" class="rounded" method="post" action="/insereutilizador" modelAttribute="utilizador"  >
            ...
            <div class="field" id="2">
                <label>Nome:</label>
                <form:input class="input" path="nome" required="required" pattern="[a-z\s]+$"/>
            </div>                   
            <div  class="field" id="3">
                <label>Password :</label>
                <form:input type="password" class="input" required="required" path="password" />
            </div>
            ...
            <div class="field" id="6">
                ...
                <form:input  class="input" path="telefone" required="required" pattern="\([0-9]{2}\) [0-9]{4,6}-[0-9]{3,4}$"/>
            </div>
