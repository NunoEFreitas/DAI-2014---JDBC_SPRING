	...
	if(session.getAttribute("perfil").equals(6)){ %>  
	 ...
	 <% 
        ...
        <Div  class = "cabecalho da pagina" > 
            <h1> Editar Utilizadores <small>  Editar treinador </small>  </h1> 
        </div>
        ...
        <form:form id="contactform" name="editar" class="rounded" method="post" action="/update" modelAttribute="utilizador">
            ...
            <form:input type="text" path="dataNascimento" required="required" class="input" value="${map.user.getDataNascimento()}" /><br>	
            <label>Morada :</label>
