...
<html>
  ...
  <link href="<c:url value="/resources/css/styleCampo.css" />" rel="stylesheet"  type="text/css" />
    <body>
        <h1 id="formacao"> Rotação P<label id="r">1<label> </h1>
                    ...
                    <div id="campo">
                        ...
                        <div class="element7" id="pos7" name="pos7" ><label id="p7">1</label> <br> <label id="l7"> ADV 7 </label></div>
                        <div class="element12" id="pos12" name="pos12" ><label id="p12">6</label> <br> <label id="l12"> ADV 12 </label></div>
                        <div class="element11" id="pos11" name="pos11" ><label id="p11">5</label> <br> <label id="l11"> ADV 11</label></div>
                        <div class="element10" id="pos10" name="pos10" ><label id="p10">4</label> <br> <label id="l10"> ADV 10</label></div>
                        <div class="element9" id="pos9" name="pos9" ><label id="p9">3</label> <br> <label id="l9"> ADV 9</label></div>
                        <div class="element8" id="pos8" name="pos8" ><label id="p8">2</label> <br> <label id="l8"> ADV 8</label></div>
